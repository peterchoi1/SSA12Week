		...
		for(int i = 0; i < parts.length; i++){
				...
				if(firstLetter.equals(consonants.substring(z, z + 1))) {
					...
					for(int x = 0; x < vowels.length(); x++) {
						...
						if(secondLetter.equals(vowels.substring(x, x + 1))){
							...
							//System.out.println(parts[i].substring(1, parts[i].length()) + firstLetter + "ay");
							sentence = sentence + " " + (parts[i].substring(1, parts[i].length()) + firstLetter + "ay");
							break;
					...
					if(secondLetter.equals(consonants.substring(c, c + 1))){
						...
						//System.out.println(parts[i].substring(2, parts[i].length()) + firstLetter + secondLetter + "ay");
						sentence = sentence + " " + (parts[i].substring(2, parts[i].length()) + firstLetter + secondLetter + "ay");
						break;
			...
			for(int v = 0; v < vowels.length(); v++) {
				...
				if(firstLetter.equals(vowels.substring(v, v + 1))) {
					//System.out.println(parts[i].substring(0, parts[i].length()) + "way");
